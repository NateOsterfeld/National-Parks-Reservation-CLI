...
Drop Database dbNationalParkReservation
Create Database dbNationalParkReservation

Use dbNationalParkReservation

If Object_ID ('reservation') Is Not Null Drop Table reservation
If Object_ID ('site') Is Not Null Drop Table site
If Object_ID ('campground') Is Not Null Drop Table campground
...
-- -------------------------------------------------------------------------- --
-- test queries --
--select * from park where park_id = 1;

--select park.name, campground.name, campground.daily_fee, campground.open_from_mm, campground.open_to_mm from campground 
--join park
--	on campground.park_id = park.park_id
--Where park.park_id = 3
--order by campground.name

--select * from site

--select campground.campground_id, site.site_number, site.max_occupancy, site.accessible, site.max_rv_length, site.utilities
--from site
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
--where park.park_id = 1
--order by campground.campground_id

--select site.site_number, site.max_occupancy, site.accessible, site.max_rv_length, site.utilities
--from site
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
--where park.park_id = 1 and campground.campground_id = 1
--and site.accessible = 0
----and site.max_rv_length > 0
----and site.utilities = 0
...
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
--where park.park_id = 1 and campground.campground_id = 1 and site.site_id = 3

-- ---------------------------------------------------------------------------------- --
-- build reservation queries 
-- ---------------------------------------------------------------------------------- --

-- campsites based on park
--select park.name, campground.name, campground.daily_fee, campground.open_from_mm, campground.open_to_mm from campground 
--join park
--	on campground.park_id = park.park_id
--Where park.park_id = 1
...
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
--order by park.name, campground.name, site.accessible, site.max_rv_length, site.utilities

--select site.site_number, campground.campground_id, reservation.reservation_id, reservation.from_date, reservation.to_date, site.max_occupancy, site.accessible, site.max_rv_length
--from reservation
--join site on reservation.site_id = site.site_id
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
...
--where reservation.from_date < '2018-06-29' and reservation.to_date > '2018-07-03'
--and reservation.from_date > '2018-07-03' and reservation.to_date < '2018-07-03'
--and park.park_id = 1 and campground.campground_id = 1
...
--select from_date from reservation
--join site on reservation.site_id = site.site_id
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
--where reservation.from_date < '2018-06-29' and reservation.to_date > '2018-07-03'
...
--select site.site_number from site
--join reservation on site.site_id = reservation.site_id
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
--where reservation.from_date not between Cast('2018-06-30' as Date) and Cast('2018-07-05' as Date)
--and reservation.to_date not between Cast('2018-06-30' as Date) and Cast('2018-07-05' as Date)
-- and park.park_id = 1 and campground.campground_id = 1
--and ('2018-06-30' not between reservation.from_date and reservation.to_date)
--or ('2018-07-05' not between reservation.from_date and reservation.to_date)
--and reservation.reservation_id is null

--select park.name, campground.name, site.site_id, site.site_number from site
--join campground on site.campground_id = campground.campground_id
--join park on campground.park_id = park.park_id
--order by park.name, campground.name Asc
...
----(reservation.from_date not between Cast('2018-06-30' as Date) and Cast('2018-07-05' as Date))
----and (reservation.to_date not between Cast('2018-06-30' as Date) and Cast('2018-07-05' as Date))
----or 
--and park.park_id = 1 and campground.campground_id = 1


select site.site_number, site.max_occupancy, site.accessible, site.max_rv_length, site.utilities, campground.daily_fee from site
left join reservation on site.site_id = reservation.site_id
join campground on site.campground_id = campground.campground_id
join park on campground.park_id = park.park_id
where park.park_id = 1 and campground.campground_id = 1
...
select park.name, campground.name, site.site_id, site.site_number, reservation.reservation_id from site
left join reservation on site.site_id = reservation.site_id
join campground on site.campground_id = campground.campground_id
join park on campground.park_id = park.park_id
where exists (select site.site_number from site
				join reservation on site.site_id = reservation.site_id
				where (reservation.from_date between Cast('2018-06-30' as Date) and Cast('2018-07-05' as Date))
				and (reservation.to_date between Cast('2018-06-30' as Date) and Cast('2018-07-05' as Date)))
and park.park_id = 1 and campground.campground_id = 1